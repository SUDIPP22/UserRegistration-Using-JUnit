...
public class UserValidatorTest {
    ...
    void givenFirstName_WhenProper_ShouldReturnTrue() {
        ...
        try {
            result = validator.validFirstName("Sudip");
    ...
    void givenFirstName_WhenShort_ShouldReturnFalse() {
        ...
        boolean result = false;
        try {
            result = validator.validFirstName("Su");
        } catch (UserRegistrationException e) {
            e.printStackTrace();
        }
    ...
    void givenFirstName_WhenWithNumberOrSpecialCharacters_ShouldReturnFalse() {
        ...
        boolean result = false;
        try {
            result = validator.validFirstName("Su@dip");
        } catch (UserRegistrationException e) {
            e.printStackTrace();
        }
        Assertions.assertFalse(result);
    ...
    void givenLastName_WhenProper_ShouldReturnTrue() {
        ...
        boolean result = false;
        try {
            result = validator.validateLastName("Panja");
        } catch (UserRegistrationException e) {
            e.printStackTrace();
        }
        Assertions.assertTrue(result);
    ...
    void givenLastName_WhenShort_ShouldReturnFalse() {
        ...
        boolean result = false;
        try {
            result = validator.validateLastName("Pa");
        } catch (UserRegistrationException e) {
            e.printStackTrace();
        }
        Assertions.assertFalse(result);
    ...
    void givenLastName_WhenWithNumberOrSpecialCharacters_ShouldReturnFalse() {
        ...
        boolean result = false;
        try {
            result = validator.validateLastName("Pa#nja");
        } catch (UserRegistrationException e) {
            e.printStackTrace();
        }
        Assertions.assertFalse(result);
    ...
    void givenEmail_WhenValid_ShouldReturnTrue() {
        ...
        boolean result = false;
        try {
            result = validator.validateEmailAddress("panja370@gmail.com");
        } catch (UserRegistrationException e) {
            e.printStackTrace();
        }
        Assertions.assertTrue(result);
    ...
    void givenEmail_WhenDomainNameIsMissing_ShouldReturnFalse() {
        ...
        boolean result = false;
        try {
            result = validator.validateEmailAddress("panja370@.com");
        } catch (UserRegistrationException e) {
            e.printStackTrace();
        }
        Assertions.assertFalse(result);
    ...
    void givenEmail_WhenMainTldIsMissing_ShouldReturnFalse() {
        ...
        boolean result = false;
        try {
            result = validator.validateEmailAddress("panja370@gmail");
        } catch (UserRegistrationException e) {
            e.printStackTrace();
        }
        Assertions.assertFalse(result);
